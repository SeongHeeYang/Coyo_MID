...
{
	private String big_ing_name, mid_ing_name, unit_name, r_ing_weight, r_step_content, r_step_img, r_cl_img
				, r_main_img, r_title, r_content, fd_type_id, fd_stu_id, mid_ing_id, pp_id, ct_id, dif_id, r_tag;
